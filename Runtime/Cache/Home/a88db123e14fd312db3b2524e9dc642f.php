<?php if (!defined('THINK_PATH')) exit();?><div class="wrapper wrapper-content animated fadeInDown">
    ...
    <!--<?php dump($info);?>-->
    <form action="/School/editinfo/id/<?php echo ($info["userid"]); ?>" method="post">
        <div class="row">
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <div class="row">
                            <div class="col-lg-12">
                                <h2><?php echo ($info["name"]); ?><span
                                        class="btn btn-white btn-xs"
                                        style="margin-left: 10px"><?php echo ($info["schoolname"]); ?></span><span
                                        class="btn btn-white btn-xs"
                                        style="margin-left: 10px"><?php echo getStuClass($info['classid'])?></span><span
                                        class="btn btn-white btn-xs"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-1 pull-right">
                                <a href="/School/reset/id/<?php echo ($info["userid"]); ?>/klass/<?php echo ($vo["classid"]); ?>">
